...
<html>
    ...
    <style type="text/css">
      * {
      ...
      #search.hover {
        ...
        cursor: pointer;
        border-radius: 30px;
        background: rgb(3, 241, 83);
        color: #081b29;
        box-shadow: 0 0 20px rgb(2, 239, 14);
      }
      .navbar li {
        list-style: none;
      ...
      .signup {
        margin: 0px 10px;
        border: 2px solid rgb(8, 91, 247);
        padding: 13px 35px;
        letter-spacing: 1px;
        color: white;
        border-radius: 30px;
        background-color: rgb(47, 7, 244);
        text-decoration: none;
      }
      .signup:hover {
        border: 2px solid rgb(76, 3, 231);
        color: rgb(4, 4, 251);
        background-color: white;
        transition: 0.5s;
        cursor: pointer;
  ...
  <body>
    <div class="banner">
      <br />
      <div class="navbar">
        <h1 class="logo">S<span>S</span>M<span>ULTITECH</span></h1>
        <ul>
    ...
    <style type="text/css">
      * {
      ...
      .bg-product {
        ...
        padding: 10px;
        color: white;
        background-color: rgb(192, 239, 4);
        border-radius: 30px;
      }
      .logo {
        color: #d1f602;
      ...
      .navbar li:hover {
        ...
        cursor: pointer;
        border-radius: 30px;
        background: rgb(227, 247, 4);
        color: #081b29;
        box-shadow: 0 0 20px rgb(202, 242, 1);
      }
      .container {
        background: transparent;
        padding: 10px 5%;
      ...
      footer {
        ...
        cursor: pointer;
        border-radius: 30px;
        background: rgb(243, 235, 2);
        color: #081b29;
        box-shadow: 0 0 20px rgb(238, 246, 3);
      }
    </style>
  </head>
  <body>
    ...
    <div class="banner">
      ...
      <div class="image">
        <table cellspacing="80" >
          <tr align="center">
            <td><img src="IMG1EX7.jpg" /></td>
            <td><img src="IMG2EX7.jpg" /></td>
            <td><img src="IMG3EX7.jpg" /></td>
            <td><img src="IMG4EX7.jpg" /></td>
            <td><img src="IMG5EX7.jpg" /></td>
            <td><img src="IMG6EX7.jpeg" /></td>
          </tr>
    ...
    <style type="text/css">
      * {
      ...
      .bg-contact {
        ...
        padding: 10px;
        color: white;
        background-color:rgb(170, 241, 4);
        border-radius: 30px;
      }
      .logo {
        color: rgb(210, 246, 9);
      ...
      .navbar li:hover {
        ...
        cursor: pointer;
        border-radius: 30px;
        background: rgb(197, 236, 2);
        color: #081b29;
        box-shadow: 0 0 20px rgb(226, 234, 1);
      }
      .box {
        display: flex;
        column-gap: 40px;
      ...
      footer {
        ...
        cursor: pointer;
        border-radius: 30px;
        background: rgb(205, 236, 2);
        color: #081b29;
        box-shadow: 0 0 20px rgb(233, 237, 1);
      }
    </style>
  </head>
  <body>
    <div class="banner">
      ...
      <div class="box">
        ...
        <div class="box-2">
          ...
          <p><span>Email</span> : ssmultitech.official@gmail.com</p>
